...
<p style="text-align: center">Chúng tôi cam kết mang lại sản phẩm
	chất lượng cao & thời tranng đến cho khách hàng khi mua hàng tại shop
	chúng tôi</p>
						...
						<form action="" method="post">
							<center>
								<button class="btn btn-primary"
									formaction="/themVaoGioNu?id=${item.getIdSP()}">Thêm
									vào giỏ</button>
						</form>
						</center>
						<br>
